...
const EMAIL_TEMPLATE_CATALOG = [
  ...
  },
  {
    ...
    required_data: ['name', 'store_name', 'ip_address', 'device', 'location', 'signed_in_at']
  },
  {
  ...
  },
  {
    ...
    required_data: ['name', 'store_name', 'plan_name', 'trial_ends_at']
  },
  {
    ...
    required_data: ['name', 'store_name', 'plan_name', 'trial_ends_at', 'amount', 'currency']
  },
  {
    ...
    required_data: ['name', 'store_name', 'status']
  },
  {
    ...
    required_data: ['name', 'store_name', 'invoice_id', 'amount', 'currency', 'due_at']
  },
  {
    ...
    required_data: ['name', 'store_name', 'invoice_id', 'amount', 'currency', 'paid_at']
  },
  {
    ...
    trigger: 'PAYMENT_FAILED for invoice entities',
    required_data: ['name', 'store_name', 'invoice_id', 'amount', 'currency']
  },
  {
    ...
    trigger: 'SUBSCRIPTION_CHANGED after renewal',
    required_data: ['name', 'store_name', 'plan_name', 'current_period_end']
  },
  {
    ...
    required_data: ['name', 'store_name', 'current_period_end']
  },
  {
    ...
    required_data: ['name', 'store_name', 'cancelled_at']
  },
  {
    ...
    required_data: ['name', 'store_name', 'status', 'review_notes']
  },
  {
  ...
  },
  {
    ...
    required_data: ['name', 'order_id', 'amount', 'currency', 'paid_at']
  },
  {
  ...
  },
  {
    ...
    required_data: ['name', 'invoice_id', 'amount', 'currency', 'due_at']
  },
  {
  ...
  },
  {
    ...
    required_data: ['name', 'order_id', 'tracking_number', 'carrier']
  },
  {
    ...
    required_data: ['name', 'order_id', 'delivered_at']
  },
  {
    ...
    required_data: ['name', 'order_id', 'cancelled_at']
  },
  {
    ...
    required_data: ['name', 'order_id', 'amount', 'currency', 'refunded_at']
  },
  {
